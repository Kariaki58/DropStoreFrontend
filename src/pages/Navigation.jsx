    ...
    <header className='bg-white border-b-2 shadow-sm'>
      {displayDuration && status && (
        ...
        <div className="px-4 py-3 shadow-md" role="alert">
          <div className="flex">
            <div className="py-1"><svg class="fill-current h-6 w-6 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z"/></svg></div>
            <div>
      ...
      <nav className='container flex justify-between items-center p-1.5 mx-auto'>
        <div className='flex gap-16'>
          <h1 className='text-[#343A40] text-3xl'>
            <Link to='/'>DropStore</Link>
          </h1>
          <div className='hidden md:flex w-[500px] card rounded-lg relative border'>
            <input placeholder='Search...' className='placeholder:text-[#343440] w-[460px] py-3 px-2 font-medium text-[#343440] focus:outline-none  rounded-l-lg' />
